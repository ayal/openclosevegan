...
/******/ 	var hotCurrentHash = "f796392d6301bc1c8920"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports) {
	...
	var bb_success;var bb_error;var bb_blackberryTimeout_id = -1;function handleBlackBerryLocationTimeout() {
	  ...
	  var b = {};var c = null;var a = "undefined";b.getCurrentPosition = function (f, d, e) {
	    ...
	    try {
	      if ((typeof geo_position_js_simulator === 'undefined' ? 'undefined' : _typeof(geo_position_js_simulator)) != a) {
	        c = geo_position_js_simulator;
	      } else {
	        if ((typeof bondi === 'undefined' ? 'undefined' : _typeof(bondi)) != a && _typeof(bondi.geolocation) != a) {
	          c = bondi.geolocation;
	        } else {
	          if (_typeof(navigator.geolocation) != a) {
	            c = navigator.geolocation;b.getCurrentPosition = function (h, e, g) {
	              function f(i) {
	                if (_typeof(i.latitude) != a) {
	            ...
	            if (_typeof(window.blackberry) != a && blackberry.location.GPSSupported) {
	              if (_typeof(blackberry.location.setAidMode) == a) {
	                return false;
	              ...
	              if (_typeof(window.google) != a && _typeof(google.gears) != a) {
	                c = google.gears.factory.create("beta.geolocation");
	              } else {
	                if ((typeof Mojo === 'undefined' ? 'undefined' : _typeof(Mojo)) != a && typeof Mojo.Service.Request != "Mojo.Service.Request") {
	                  ...
	                  if ((typeof device === 'undefined' ? 'undefined' : _typeof(device)) != a && _typeof(device.getServiceObject) != a) {
	      ...
	      if ((typeof console === 'undefined' ? 'undefined' : _typeof(console)) != a) {
	        console.log(d);
	      }return false;
	    }return c != null;
	  };return b;
